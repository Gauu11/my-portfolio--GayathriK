	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				...
				<p className="text-sm sm:text-base text-gray-400 mb-6">Looking for a developer who can create interactive web experiences?</p>
				...
				<div className="flex items-center justify-center gap-2 text-gray-400 mb-8">
					...
					<span>Chengalpattu, TAMILNADU</span>
				</div>

				{/* Contact Buttons */}
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="https://mail.google.com/mail/?view=cm&fs=1&to=gayu6675@gmail.com"
				...
				<div className="flex justify-center gap-6">
					...
					<a
						href="https://www.linkedin.com/in/gayathrik-/"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
